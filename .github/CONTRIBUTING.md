...
> If you want to ask a question, we assume that you have read the available [Documentation](https://registry.terraform.io/providers/blrvio/unifi/latest/docs).

Before you ask a question, it is best to search for existing [Discussions](https://github.com/blrvio/terraform-provider-unifi/discussions) or [issues](https://github.com/blrvio/terraform-provider-unifi/issues)
...
- Open a [Discussion](https://github.com/blrvio/terraform-provider-unifi/discussions/new/choose).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment components/versions (Make sure that you have read
  the [documentation](https://registry.terraform.io/providers/blrvio/unifi/latest/docs). If you are looking for support, you might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in
  the [bug tracker](https://github.com/blrvio/terraform-provider-unifi/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/blrvio/terraform-provider-unifi/issues/new?template=bug_report.md)
...
- Read the [documentation](https://registry.terraform.io/providers/blrvio/unifi/latest/docs) carefully and find out if the functionality is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/blrvio/terraform-provider-unifi/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/blrvio/terraform-provider-unifi/issues).
...
1. Clone the repository
   ```bash
   git clone https://github.com/blrvio/terraform-provider-unifi.git
   ```
